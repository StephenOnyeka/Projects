...
function About() {
  return (
    <div>
      <div>
        {/* <div className="bg-[url('/images/about/aboutbg.jpeg')] bg-cover bg-no-repeat bg-center-top transform scale-x-[-1] ">
          <div className="h-screen p-8 max-sm:px-4  transform scale-x-[-1] flex items-center max-md:h-screen/2 "> */}
