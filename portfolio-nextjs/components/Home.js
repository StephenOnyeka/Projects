...
function HeroAnimatedCard() {
  ...
  return (
    <div
      className="rounded-3xl shadow-2xl p-10 md:p-16 flex flex-col items-center text-center gap-6 animate-fadeIn w-full "
      data-aos="fade-up"
    >
      <h1
    ...
    <div className=" min-h-screen w-full overflow-x-hidden">
      ...
      <div className="min-h-screen w-full bg-[#0b001a] flex flex-col font-Montserrat">
        ...
        >
          ...
          <p
            className="name racking-widest text-3xl max-sm:text-2xl font-semibold normal text-center mb-10 font-Inter"
            data-aos="fade-up"
          >
