...
function History() {
  ...
  return (
    ...
    <div className="relative w-full overflow-hidden rounded-3xl group" style={{ clipPath: 'inset(0)' }}>
        {/* Background Video */}
        ...
        <div className='relative z-10 flex flex-col px-8 md:px-32 py-8'>
            {experience.map((item) => (
                <div key={item.year} className='flex md:flex-row md:justify-between items-start md:items-center gap-4 border-b-[0.2px] border-white/20 py-8 hover:bg-white/5 transition-all duration-300 px-4 -mx-4'>
